...
**ꜰᴏʀᴍᴀᴛ:** `ᴜʀʟ ᴀᴘɪ`
**ᴇxᴀᴍᴘʟᴇ:** `inshorturl.com 94358946563495834957348`"""
...
async def set_tutorial_link(client: Client, query: CallbackQuery):
    ...
    current_tutorial = getattr(client, 'tutorial_link', "https://t.me/how_to_open_link_ak/16")
...
**ᴇxᴀᴍᴘʟᴇ:** `https://t.me/how_to_open_link_ak/16`"""
